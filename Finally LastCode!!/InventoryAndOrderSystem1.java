...
public class InventoryAndOrderSystem1 {
    ...
    public static LinkedList<Orders>  orders;
...
public static void AddNewReview()
{
      ...
      public static void PlaceOrder() {
        try {
            ...
            if (newOrder != null) {
                ...
                customers.findFirst();
                for (int i = 0; i < customers.size(); i++) {
                    if (customers.retrieve().getCustomerId() == newOrder.getCustomerRef()) {
                        Customers cust = customers.retrieve();
                        customers.remove();
                        cust.addOrder(newOrder.getOrderId());
    ...
    public static void CancelOrder()
    {
        try {
            ...
            Orders cancel_order = odata.searchById(oid);
    ...
    public static void commonProducts( int cid1 , int cid2)
    {
        ...
        //find all products for customer 1 and customer 2 that are reviewd
        reviews = rdata.getReviewData();
        ...
        if (! reviews.empty())
        {
            ...
            PQ_LinkedList<Products> AVGrate45 = new PQ_LinkedList<Products> ();
