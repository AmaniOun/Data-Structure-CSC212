    ...
    public static void CustomersMenu() {
        ...
        do {
            try {
                ...
                System.out.println("4. View all customers sorted by ID");
        ...
        try {
            ...
            if (odata.cancelOrder(oid) == 1) {
                ...
                for (int x = 0; x < cancel_order.getProducts().size(); x++) {
                    int prodId = cancel_order.getProducts().retrieve();
                    ...
                    if (!cancel_order.getProducts().last())
